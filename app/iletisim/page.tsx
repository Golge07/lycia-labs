      ...
      <div className="grid gap-8 rounded-3xl border border-[rgba(59,43,43,0.12)] bg-white/80 p-6 shadow-2xl lg:grid-cols-2">
        <section className="space-y-4">
          ...
          <p className="leading-relaxed text-[rgba(59,43,43,0.75)]">
            Distribütörlük, basın veya iş birliği için formu doldurun. Dummy alanlar; entegrasyon Supabase ile sağlanacak.
          </p>
          <form className="space-y-4">
            <div className="grid gap-4 md:grid-cols-2">
              <div className="space-y-2">
                <label className="text-sm text-[rgba(59,43,43,0.7)]">Ad Soyad</label>
                <input
              ...
              <div className="space-y-2">
                <label className="text-sm text-[rgba(59,43,43,0.7)]">E-posta</label>
                <input
                  type="email"
                  className="w-full rounded-xl border border-[rgba(59,43,43,0.15)] bg-white/80 px-4 py-3 text-foreground placeholder:text-[rgba(59,43,43,0.4)] focus:border-[var(--terracotta)] focus:outline-none"
            ...
            <div className="space-y-2">
              <label className="text-sm text-[rgba(59,43,43,0.7)]">Mesaj</label>
              <textarea
                rows={5}
                className="w-full rounded-xl border border-[rgba(59,43,43,0.15)] bg-white/80 px-4 py-3 text-foreground placeholder:text-[rgba(59,43,43,0.4)] focus:border-[var(--terracotta)] focus:outline-none"
            ...
            <button className="w-full rounded-full bg-[var(--terracotta)] px-6 py-3 text-sm font-semibold text-white shadow-lg shadow-[rgba(167,68,68,0.2)] transition hover:shadow-xl">
              Mesajı Gönder
            </button>
          </form>
        </section>
        ...
        <aside className="space-y-4 rounded-2xl border border-[rgba(59,43,43,0.12)] bg-white/90 p-4 shadow-xl">
          ...
          <div className="space-y-2 text-sm text-[rgba(59,43,43,0.75)]">
            <p><span className="font-semibold text-foreground">Adres:</span> Levent, İstanbul (örnek konum)</p>
            <p><span className="font-semibold text-foreground">Telefon:</span> +90 212 000 00 00</p>
            <p><span className="font-semibold text-foreground">E-posta:</span> hello@lycialabs.com</p>
          </div>
        </aside>
      </div>
    </main>
