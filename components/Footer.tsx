...
export default function Footer() {
  return (
    <footer className="w-full border-t border-[rgba(59,43,43,0.12)] bg-white/80 px-6 py-10 text-base text-[rgba(59,43,43,0.7)] backdrop-blur md:px-12 lg:px-20">
      <div className="grid gap-6 md:grid-cols-4 md:items-start">
        <div className="col-span-2 flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-[rgba(59,43,43,0.65)]">Akdeniz’den ilham alan temiz bakım.</p>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-3">
          ...
          <p className="text-sm text-[rgba(59,43,43,0.65)]">Bizi sosyal medyada takip edin.</p>
        </div>
      </div>

      <div className="mt-6 border-t border-[rgba(59,43,43,0.12)] pt-4 text-sm text-[rgba(59,43,43,0.6)]">
